...
import { getElementBounds, getStrokeBounds, type WhiteboardSelectionRect } from '@/components/Whiteboard/model/interaction/whiteboardSelection';
import { WHITEBOARD_INITIAL_VIEWPORT, clampWhiteboardZoom } from '@/components/Whiteboard/model/core/whiteboardModel';
