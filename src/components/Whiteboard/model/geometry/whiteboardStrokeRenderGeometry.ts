...
import { getStrokeWidth, isLinearTool, type WhiteboardDrawingTool, type WhiteboardStroke, type WhiteboardStrokePoint } from '@/components/Whiteboard/model/core/whiteboardModel';
