...
import { splitWhiteboardStrokeSegments } from '@/components/Whiteboard/model/geometry/whiteboardStrokeSegments';
import { isWhiteboardAutoDrawIcon } from '@/components/Whiteboard/model/autodraw/whiteboardAutoDrawTypes';
